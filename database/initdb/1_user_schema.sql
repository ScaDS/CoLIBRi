...
COPY searchdata(searchdata_id, drawing_id, shape, material, general_tolerances, surfaces, gdts, threads, outer_dimensions, search_vector, part_number, ocr_text, runtime_text)
